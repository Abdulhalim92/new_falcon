...
func (j *JwtHelper) GetUserRoles() []string {
	return parseRealmRoles(j.claims)
}
...
func parseUsername(claims jwt.MapClaims) string {
	username, err := parseString(claims, "preferred_username")
	if err != nil {
		return ""
	}
	return username
